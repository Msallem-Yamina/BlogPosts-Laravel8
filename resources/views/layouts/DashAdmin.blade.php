      ...
      <div class="row">
        <div class="col-12">
          <nav class="main-nav">
            ...
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
                <li class="scroll-to-section"><a href="{{ route('Allposts')}}" class="active">Posts</a></li>
                <li class="scroll-to-section"><a href="{{ route('users')}}">Users</a></li>
                <li class="scroll-to-section"><a href="{{route('touscomments')}}">Comments</a></li>
